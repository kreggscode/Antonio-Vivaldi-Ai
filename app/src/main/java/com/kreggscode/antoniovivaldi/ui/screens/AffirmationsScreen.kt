...
import com.kreggscode.antoniovivaldi.data.AffirmationsDataLoader
    ...
    Box(
        ...
        Scaffold(
            ...
            if (isLoading) {
                        ...
                        DailyAffirmationCard(
                            ...
                            onShareClick = {
                                val shareIntent = Intent(Intent.ACTION_SEND).apply {
                                    type = "text/plain"
                                    putExtra(Intent.EXTRA_TEXT, "\"${affirmation.text}\"\n\n- Antonio Vivaldi Affirmation (${affirmation.category})")
                                }
                ...
                item {
                    Text(
                        "🌟 Antonio Vivaldi-Inspired Affirmations",
...
fun BreathingExerciseCard() {
    ...
    GlassmorphicCard(
        ...
        Column(
            ...
            Text(
                "Take a moment to center yourself with Vivaldi's wisdom",
...
fun generateAntonioVivaldiAffirmations(): List<Affirmation> {
    return listOf(
        ...
        Affirmation(
            2,
            "Like Antonio Vivaldi, I question everything and seek deeper understanding.",
            "Wisdom",
            "🤔",
