...
fun PremiumFeaturesScreen(
    ...
    val features = listOf(
        ...
        PremiumFeature(
            ...
            description = "Chat with Antonio Vivaldi AI\n• Personalized wisdom\n• Deep philosophical discussions\n• Context-aware responses\n• Daily AI insights",
            price = "$4.99/mo",
        ...
        PremiumFeature(
            ...
            description = "Vivaldi's voice experience\n• Quote narration\n• Guided meditation\n• Sleep stories\n• Background music",
            price = "$3.99",
...
fun TestimonialsSection() {
    val testimonials = listOf(
        ...
        "\"I start every day with Vivaldi's wisdom now.\" - Maria L."
    )
