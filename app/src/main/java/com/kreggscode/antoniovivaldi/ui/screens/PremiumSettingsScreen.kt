                    ...
                    onShareClick = {
                        try {
                            val shareIntent = Intent(Intent.ACTION_SEND).apply {
                                type = "text/plain"
                                putExtra(Intent.EXTRA_SUBJECT, "Antonio Vivaldi AI")
                                putExtra(Intent.EXTRA_TEXT, "Check out Antonio Vivaldi AI app! Explore the genius of Antonio Vivaldi and Baroque music.\n\nhttps://play.google.com/store/apps/details?id=com.kreggscode.antoniovivaldi")
                            }
                ...
                RateAppSection(
                    onRateClick = {
                        try {
                            ...
                            val playStoreIntent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.kreggscode.antoniovivaldi"))
                            playStoreIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                            context.startActivity(playStoreIntent)
                        } catch (e: Exception) {
                            // If Play Store app is not available, open in browser
                            try {
                                val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.kreggscode.antoniovivaldi"))
        ...
        Row(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        "Share Antonio Vivaldi wisdom with friends",
                        style = MaterialTheme.typography.bodySmall,
                        color = PremiumColors.CyberBlue
                    )
                }
                    ...
                    onClick = {
                        try {
                            val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                                ...
                                putExtra(Intent.EXTRA_SUBJECT, "Antonio Vivaldi App Feedback")
                            }
        ...
        Column(
            ...
            SettingRow(
                ...
                onClick = {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        data = Uri.parse("mailto:kreg9da@gmail.com")
                        putExtra(Intent.EXTRA_SUBJECT, "Antonio Vivaldi App - Bug Report")
            ...
            SettingRow(
                ...
                onClick = {
                    val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                        data = Uri.parse("mailto:kreg9da@gmail.com")
                        putExtra(Intent.EXTRA_SUBJECT, "Antonio Vivaldi App - Support Request")
                    }
                    context.startActivity(emailIntent)
                }
            )
